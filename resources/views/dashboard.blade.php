        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-800 flex items-center justify-between">
                    <div>
                        <h3 class="text-lg font-semibold">Phase 5 Reporting Ready</h3>
                        <p class="mt-2 text-sm text-gray-600">
                            The dashboard now uses live aggregates, and reporting views are available for sales and stock monitoring.
                        </p>
                    </div>
